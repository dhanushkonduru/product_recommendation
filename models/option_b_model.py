...
def main():
    ...
    model_path = os.path.join(os.path.dirname(__file__), '..', 'option_b_model.pt')
    ...
    results_path = os.path.join(os.path.dirname(__file__), '..', 'option_b_results.pkl')
...
def recommend(user_id: str, top_k: int = 10) -> List[Dict]:
    ...
    Loads the option_b_model.pt and returns recommendations.
